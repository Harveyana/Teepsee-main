    ...
    <div class="container row justify-center self-start" style="">
      <q-card flat class="cart" style="">
        <q-card class="card-headers q-mt-lg row justify-around">
          ...
          >
          <q-card class="Price"
            ><h3 class="PriceLabel card-header" style="">Email</h3></q-card
          >
          <q-card class="Brand"
            ><h3 class="BrandLabel card-header" style="">Mobile</h3></q-card
          >
          <q-card class="Category"
            ><h3 class="CategoryLabel card-header" style="">Address</h3></q-card
          >
          <q-card class="Edit"

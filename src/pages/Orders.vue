      ...
      <q-card flat class="cart bg-grey-3" style="">
        <q-card class="card-headers q-mt-lg row justify-around">
          <q-card class="ImageAndName"
            ><h3 class="ImageAndNameLabel card-header" style="">Order Id</h3></q-card
          >
          <q-card class="Price"
            ><h3 class="PriceLabel card-header" style="">Quantity</h3></q-card
          >
          <q-card class="Brand"
            ><h3 class="BrandLabel card-header" style="">Amount</h3></q-card
          >
          <q-card class="Category"
            ><h3 class="CategoryLabel card-header" style="">Status</h3></q-card
          >
        </q-card>

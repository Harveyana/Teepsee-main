<template>
  <q-page class="">
      ...
      <q-item class="" style="position: relative; left: 9%">
        ...
        >
          <q-popup-proxy
            ...
            style="position: relative; right: 10%; width: 30vw"
    ...
    <div class="container row justify-center self-start" style="">
      <q-card flat class="cart bg-grey-3" style="">
        <q-card class="card-headers q-mt-lg row justify-around">
          <q-card class="ImageAndName"
            ><h3 class="ImageAndNameLabel card-header" style="">Coupon Name</h3></q-card
          >
          <q-card class="Price"
            ><h3 class="PriceLabel card-header" style="">Discount</h3></q-card
          >
          <q-card class="Brand"
            ><h3 class="BrandLabel card-header" style="">Code</h3></q-card
          >
          <q-card class="Category"
            ><h3 class="CategoryLabel card-header" style="">Users</h3></q-card
          >
        </q-card>
